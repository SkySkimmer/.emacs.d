...
(use-package tuareg
  ...
  :config
  (define-key tuareg-mode-map (kbd "C-x C-a")
    (defhydra hydra-ocamldebug
      (tuareg-mode-map "C-x C-a")
      "Ocamldebug"
      ("<" ocamldebug-up "Up")
      (">" ocamldebug-down "Down")
      ("b" ocamldebug-break "Break")
      ("c" ocamldebug-close "Close")
      ("d" ocamldebug-delete "Delete")
      ("f" ocamldebug-finish "Finish")
      ("g" ocamldebug-goto "Goto")
      ("k" ocamldebug-kill "Kill")
      ("l" ocamldebug-last "Last")
      ("n" ocamldebug-next "Next")
      ("o" ocamldebug-open "Open")
      ("p" ocamldebug-print "Print")
      ("r" ocamldebug-run "Run")
      ("s" ocamldebug-step "Step")
      ("t" ocamldebug-backtrace "Backtrace")
      ("v" ocamldebug-reverse "Reverse"))))
#+END_SRC
...
(defmacro my/coq-deftoggler (fn string &optional key &optional default)
  "Define function FN sending \"Set STRING.\" or \"Unset STRING.\" as appropriate.
The state of the option is stored in variable FN starting with DEFAULT."
  `(progn
     (if ,key
     ...
     (defun ,fn ()
       ,(concat "Command to toggle the option \""
                (proof-escape-keymap-doc string)
                "\".
Uses variable `" (symbol-name fn) "'.")
       (interactive)
       (let ((string (if ,fn
                         (progn (setq ,fn nil) (concat "Unset " ,string "."))
                       (progn (setq ,fn t) (concat "Set " ,string ".")))))
...
(defun my/coq-mode-setup ()
  ...
  (my/coq-deftoggler coq-toggle-printing-notations "Printing Notations" (kbd "C-c n") t)
